...
import estocmed.usuario.UsuarioTableModel;
...
public class CadastroUsuario extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jlTipoUsuario.setBounds(40, 240, 130, 19);
        ...
        jcTipoUsuario.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-------", "Administrador", "Funcionário" }));
        ...
        jcTipoUsuario.setBounds(40, 260, 250, 30);
        ...
        tfNomeUsuario.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(100, 44, 143), 1, true));
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/birdpoint/imagens/CadastroDeUsuario.png"))); // NOI18N
    ...
    private void btPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btPesquisarActionPerformed
        ...
        if (objetoRetorno != null) {
            ...
            jcTipoUsuario.setSelectedItem(usuario.getTipoUsuario());
    ...
    private void btSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSalvarActionPerformed
        ...
        if (tfLogin.getText().equals("") || tfNomeUsuario.getText().equals("") || tfSenha.getText().equals("") || jcTipoUsuario.getSelectedItem().equals("-------")) {
            ...
            usuario.setTipoUsuario(jcTipoUsuario.getSelectedItem().toString());
