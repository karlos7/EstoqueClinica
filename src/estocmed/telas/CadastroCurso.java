...
public class CadastroCurso extends javax.swing.JDialog {
     ...
     * @param usuario
     */
    public CadastroCurso(Usuario usuario) {
        initComponents();
    ...
    private void initComponents() {
        ...
        txtCurso.setBounds(60, 190, 480, 30);
        ...
        jlNomeUsuario3.setBounds(60, 170, 140, 20);
        ...
        jLObrigatorioNome2.setBounds(540, 190, 10, 10);

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/birdpoint/imagens/CadastroCursos.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CadastroCurso dialog = new CadastroCurso(null);
